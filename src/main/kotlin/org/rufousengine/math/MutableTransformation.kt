...
class MutableTransformation : Transformation {
     ...
     * @return This matrix for chaining.
     */
    fun makeReflectionSafe(aX: Float, aY: Float, aZ: Float) : MutableTransformation {
        val invMagnitude = 1f / sqrt(aX * aX + aY * aY + aZ * aZ)
     ...
     * @return This matrix for chaining.
     */
    fun makeReflection(aX: Float, aY: Float, aZ: Float) : MutableTransformation {
        val x = aX * -2f
        val y = aY * -2f
        val z = aZ * -2f
        val axay = x * aY
     ...
     * @return This matrix for chaining.
     */
    fun makeInvolutionSafe(aX: Float, aY: Float, aZ: Float) : MutableTransformation {
        val invMagnitude = 1f / sqrt(aX * aX + aY * aY + aZ * aZ)
     ...
     * @return This matrix for chaining.
     */
    fun makeInvolution(aX: Float, aY: Float, aZ: Float) : MutableTransformation {
        val x = aX * 2f
        val y = aY * 2f
        val z = aZ * 2f
        val axay = x * aY
